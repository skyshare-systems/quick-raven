...
const HeroSectionPage = () => {
  return (
    ...
    >
      ...
      <div className="relative flex flex-col justify-center px-5 lg:px-0 max-w-[1500px] w-full gap-5 items-center 2xl:items-stretch">
        <HeroImage
          className="absolute right-[0] 2xl:-right-[5rem] hidden 2xl:flex 2xl:w-[60rem] -z-[1] animate-pulse"
          data-aos="fade-down"
          data-aosduration="1000"
        />
        <Image
          className="flex 2xl:hidden animate-pulse"
